...
?>
<html><head><title>Task Manager with PHP and MySQL</title><link rel="stylesheet" href="<?php echo SITEURL; ?>css/style.css" /></head>
    <body>
    <div class="wrapper">
    <h1>TASK MANAGER</h1>
    <div class="menu">
        ...
        <p>
            ...
            <div class="all-tasks">
                ...
                <table class="tbl-full">
                    <tr>
                        <th>S.N.</th><th>Task Name</th><th>Priority</th>
